...
//vs32 _stop=0,bien_chay=0,_bien_adc,_retry=0,bien_adc,adc,adc_tb,adc_tb1,setup,chong_nhieu=0,chong_nhieu1=0,nho_encoder,chuan_bi_da,chong_nhieu_adc,chong_nhieu_adc1,adc_tong,adc_tong1,cam_bien,reset_ecoder1,reset_ecoder2;
//vs32 cb_dung_chan_da,cb_trai,cb_phai,cb_sau,cb_tryball,cb_cho_da,nut_star,nut_retry,nut_lay_de,cb_quang_trai,cb_quang_phai,_bien_cho_dat_tryball=0;
//vs32 cb_dung_chan_da_td,cb_trai_td,cb_phai_td,cb_sau_td,cb_tryball_td,cb_cho_da_td,nut_star_td,nut_retry_td,nut_lay_de_td,cb_quang_trai_td,cb_quang_phai_td;
//vs16 dong_co_xoay_trai,dong_co_xoay_trai_HL;

vs32 TOC_DO_DAT,toc_do_lay_bong; 
float  CHAY_VA_XOAY,GIA_TOC,TOC_DO,HUONG,MAT_ROBOT;
int LAY_LAN_DAU=0;
vs32 Dc_Trai_Xoay_Trai , Dc_Phai_Xoay_Trai , Dc_Sau_Xoay_Trai ; //ham cua IMU>0     
vs32 Dc_Trai_Xoay_Phai, Dc_Phai_Xoay_Phai , Dc_Sau_Xoay_Phai; //ham cua IMU<0
//vs32  _HUONG_XOAY_TRAI,_HUONG_XOAY_PHAI,_HUONG_XOAY_SAU,TRAI,PHAI,SAU;
vs32 goc_banh_trai,goc_banh_phai,goc_banh_sau;
...
//vs32 LUC_BT,LUC_BP,LUC_BS,ENCODER_TIMER1,ENCODER_TIMER2,ENCODER_TIMER3,ENCODER_TIMER4,ENCODER_TIMER5;
//vu8 mang_celo[6]={0,0,0,0,0,0} ;
vs32 t7,BEN_NGAT;

//================= ROBOCON BONG RO 2025 =================================================================================================

//xxxxxxxxxxxxxxxxxxxxxxxxxx BIEN SU DUNG ROBOCON BONG RO 2025 xxxxxxxxxxxxxxxxxxxxxxxxxxx
vs32 toc_do_test = 0;	
...
//xxxxxxxxxxxxxxxxxxxxxxxxxx INPUT ROBOCON 2025 xxxxxxxxxxxxxxxxxxxxxxxxxxx   
#define  CB_Ban_NhanBong					GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_2)                          
#define  Nut_on										GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_3)

#define  San_Xanh									!GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_1)
#define  San_Do										GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_1)


//xxxxxxxxxxxxxxxxxxxxxxxxxx ENCODER ROBOCON 2025 xxxxxxxxxxxxxxxxxxxxxxxxxxx
#define ENCODER_PHAI							abs(READ_ENCODER_3())
#define ENCODER_TRAI			   			abs(READ_ENCODER_1())
#define ENCODER_SAU			   				abs(READ_ENCODER_2())


//xxxxxxxxxxxxxxxxxxxxxxxxxx OUTPUT ROBOCON 2025 xxxxxxxxxxxxxxxxxxxxxxxxxxx
...
#define	 XI_LANH_KEP_ON          	GPIO_WriteBit(GPIOA, GPIO_Pin_14,0); // chan 15
#define	 XI_LANH_KEP_OFF         	GPIO_WriteBit(GPIOA, GPIO_Pin_14,1);

#define	 XI_LANH_KEP_UP          	GPIO_WriteBit(GPIOA, GPIO_Pin_15,0); // chan 15
#define	 XI_LANH_KEP_DOWN         GPIO_WriteBit(GPIOA, GPIO_Pin_15,1);

#define	 XI_LANH_KEP_XOAY_RA      GPIO_WriteBit(GPIOA, GPIO_Pin_8,0); // chan 15
#define	 XI_LANH_KEP_XOAY_VAO     GPIO_WriteBit(GPIOA, GPIO_Pin_8,1);


//xxxxxxxxxxxxxxxxxxxxxxxxxx ADC ROBOCON 2025 xxxxxxxxxxxxxxxxxxxxxxxxxxx
...
#define	dong_co_xoay_trai(B)											 ((DATA_SPEED[9]=B&0xFF)| (DATA_SPEED[8]=(B>>8)&0xFF))

//#define	DIA_CHI_START2 														   DATA_SPEED[5]=255
//#define	DIA_CHI_P2 														       DATA_SPEED[6]=2
////#define	ID2 		 																   DATA_SPEED[7]=2/////5--30--2
//#define	dong_co_xoay_trai(B)											   ((DATA_SPEED[8]=B&0xFF)| (DATA_SPEED[7]=(B>>8)&0xFF))
//--------------cum phai----------------
...
#define	dong_co_xoay_sau(D)											   ((DATA_SPEED[19]=D&0xFF)| (DATA_SPEED[18]=(D>>8)&0xFF))
//--------------cum sau ----------------
...
#define	dong_co_xoay_phai(F)										   ((DATA_SPEED[29]=F&0xFF)| (DATA_SPEED[28]=(F>>8)&0xFF))
...
#define	DIA_CHI_START8   			DATA_SPEED[34]=255    // Ðong co nâng -- cau H
#define	ID8 		 			  	    DATA_SPEED[35]=8
#define DONG_CO_TAY_RA 	  		DATA_SPEED[36]=1
#define DONG_CO_TAY_VAO 	    DATA_SPEED[36]=0
#define	DONG_CO_TAY   				DATA_SPEED[37]


#define	DIA_CHI_START9						DATA_SPEED[38]=255 // -- OK
#define	ID9												DATA_SPEED[39]=9
#define DC_Xoay_Trai				 			DATA_SPEED[40]=0
#define DC_Xoay_Phai							DATA_SPEED[40]=1
#define	DC_Xoay										DATA_SPEED[41]


//#define	DIA_CHI_START10						DATA_SPEED[42]=255 // -- OK
//#define	ID10											DATA_SPEED[43]=10
//#define Khoa_DC_Nang_Len				 	DATA_SPEED[44]=0
//#define Khoa_DC_Nang_Xuong				DATA_SPEED[44]=1
//#define	Khoa_DC_Nang							DATA_SPEED[45]
...
//#define	DC_Tay_Gap(H)				  				((DATA_SPEED[43]=H&0xFF)| (DATA_SPEED[42]=(H>>8)&0xFF))
...
//#define	ID9 		 											DATA_SPEED[46]=10
//#define	DC_Nang_Ha_R2(I)				  		((DATA_SPEED[48]=I&0xFF)| (DATA_SPEED[47]=(I>>8)&0xFF))
...
vs16 	IMU,HUONG_LG,IMU_X,IMU_Y,NGHIENG,TRUNG_BINH_SUM_ADC,VI_TRI_CHUONG_TRINH=0;
...
{		
   ...
   DMA_InitStructure.DMA_BufferSize =17;//(uint16_t)sizeof(DATA_COLOR);
...
//	
////	
////	if(TIMER==1) 			return (num_over_t1<<16)|(TIM_GetCounter(TIM1)-10000);
////	else if(TIMER==2) return (num_over_t2<<16)|(TIM_GetCounter(TIM2)-10000);
////	else if(TIMER==3) return (num_over_t3<<16)|(TIM_GetCounter(TIM3)-10000);
////	else if(TIMER==5) return (num_over_t5<<16)|(TIM_GetCounter(TIM5)-10000);
////	else return 0;
//}
...
void HMI_TRAN(vs32 _so_dong) {
		...
		//xxxxxxxxxxxxxxxxxxxxxxxxxx THONG TIN TONG QUAN CUA ROBOT (0-20) xxxxxxxxxxxxxxxxxxxxxxxxxxx			
				...
				case 1:
						HMI_DMI("gp_get_mode_uart: ", gp_get_mode_uart(), 1);													
						break;
									
				case 2:
						HMI_DMI("TOC_DO: ", TOC_DO, 2);										
						break;
									
				case 3:
						HMI_DMI("HUONG: ", HUONG, 3);				
						break;
				...
				case 5:
						HMI_DMI("_TOC_DO_BT: ", _TOC_DO_BT, 5);
						break;
				...
				case 9:
						HMI_DMI("cho_phep_chay: ", cho_phep_chay, 9);					
						break;
									
				case 10:
						HMI_DMI("ENCODER_TRAI: ", ENCODER_TRAI , 10);	 																
						break;
									
				case 11:
						HMI_DMI("ENCODER_SAU: ", ENCODER_SAU, 11);						
						break;
									
				case 12:
						HMI_DMI("ENCODER_PHAI: ", ENCODER_PHAI , 12);						
						break;
									
				case 13: 
						HMI_DMI("MAT_ROBOT: ", MAT_ROBOT, 13);					
						break;
									
				case 14:
						HMI_DMI("toc_do_test: ", toc_do_test, 14);					
						break;
									
				case 15:
						HMI_DMI("muc_tieu_xung: ", muc_tieu_xung, 15);										
						break;

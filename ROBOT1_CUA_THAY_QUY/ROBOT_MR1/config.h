...
#define Cylanh_next				 										DATA_SPEED[26]=1
#define Cylanh_back														DATA_SPEED[26]=0
#define	Cylanh	 															DATA_SPEED[27]
...
#define bien_tro_nong_ban										_ADC1_Value[0]	//OK Nang_ha
#define bien_tro_nang_bong									_ADC1_Value[3] // Ban_bong
#define bien_tro_nang_lua										_ADC1_Value[2]
#define bien_tro_xoay_nong									_ADC1_Value[1] //Xoay_nong
...
#define Encoder_0h		(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/61.2
...
int		BienTroNongBanValue, bientronangluaValue,bientroBanBongValue,BienTroXoayValue;
vu16 _ADC1_Value[8];
vu16 UWB = 0;
...
extern int KhoangCachA , KhoangCachB;
...
int Min_BT_BanBong = 200;
int Max_BT_BanBong = 525;
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 2:
										...
										//HMI_DMI("Xoay :",bien_tro_xoay_nong	,2);
										break;
									case 3:
										//HMI_DMI("--: ", bien_tro_nang_lua,3); //force , power , power_shot , calculate(lazeTraiValue_Ban)
										break;
									case 4:
										//HMI_DMI("Luu_luc : ",Luu_luc,4);Ban_1
										HMI_DMI("BT_Ban_Bong : ",bien_tro_nang_bong,4);
										break;
									case 5:
//										HMI_DMI("XI_LANH",bien_tro_nong_ban,5);
										break;
									case 6:
										HMI_DMI("Luc Ban",power_shot + power,6); //power_shot
										//HMI_DMI("layMauBT ",layMauBT,6); // power  layMauBT , erLayMauBT;
										//HMI_DMI("power_shot ",power_shot,6); //power_shot
										break;
									case 7:
										HMI_DMI("BT_NANG_HA ",BienTroNongBanValue,7); //mau_bien_tro HMI_DMI("BT_NANG_HA ", BienTroNongBanValue,7);		
										break;
									case 8:
										HMI_DMI("BT_XOAY ",BienTroXoayValue,8);
										//HMI_DMI("KCLZ ",lazeTraiValue_Ban,8);
										break;
									case 9:
										HMI_DMI("BT_BAN_BONG ", bientroBanBongValue,9);	
										break;
//										if(NUT_CHUYEN_SAN == 1){
...
//										}
										break;
									case 10:	  
										HMI_DMI("gt_td :",gt_td,10);
										break;
									case 11:
										HMI_DMI("Mor_CamRotate :",Mor_CamRotate,11);  	//Nong_Ban	

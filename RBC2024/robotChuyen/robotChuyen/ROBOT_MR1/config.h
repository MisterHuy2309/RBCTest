...
#define	DIA_CHI_START1 												DATA_SPEED[0]=255
#define	ID1 		 															DATA_SPEED[1]=1
#define mor_rotate_rear_right_next 						DATA_SPEED[2]=1
#define mor_rotate_rear_right_back						DATA_SPEED[2]=0
#define	mor_rotate_rear_right 								DATA_SPEED[3]

#define	DIA_CHI_START2												DATA_SPEED[4]=255
#define	ID2	 																	DATA_SPEED[5]=2
#define Mor_RearRight_next							 			DATA_SPEED[6]=0
#define Mor_RearRight_back										DATA_SPEED[6]=1   
#define	Mor_RearRight 		 										DATA_SPEED[7]



#define	DIA_CHI_START3 												DATA_SPEED[8]=255
#define	ID3	 		 															DATA_SPEED[9]=3
#define mor_rotate_front_right_next						DATA_SPEED[10]=1
#define mor_rotate_front_right_back						DATA_SPEED[10]=0
#define	mor_rotate_front_right 								DATA_SPEED[11]

#define	DIA_CHI_START4											  DATA_SPEED[12]=255
#define	ID4																    DATA_SPEED[13]=4
#define Mor_FrontRight_next					 					DATA_SPEED[14]=1
#define Mor_FrontRight_back										DATA_SPEED[14]=0
#define	Mor_FrontRight		 										DATA_SPEED[15]


#define	DIA_CHI_START5											  DATA_SPEED[16]=255// -- OK
#define	ID5																    DATA_SPEED[17]=5
#define mor_rotate_front_left_next				 		DATA_SPEED[18]=1
#define mor_rotate_front_left_back						DATA_SPEED[18]=0
#define	mor_rotate_front_left	 								DATA_SPEED[19]

#define	DIA_CHI_START6											  DATA_SPEED[20]=255 // -- OK
#define	ID6																    DATA_SPEED[21]=6
#define Mor_FrontLeft_next					 					DATA_SPEED[22]=0
#define Mor_FrontLeft_back										DATA_SPEED[22]=1
#define	Mor_FrontLeft	 												DATA_SPEED[23]

//==============================Co cau ====================================================================
#define	DIA_CHI_START7						DATA_SPEED[24]=255
#define	ID7												DATA_SPEED[25]=7
#define Ban_1_next					 			DATA_SPEED[26]=1
#define Ban_1_back								DATA_SPEED[26]=0
#define	Ban_1									    DATA_SPEED[27]

#define	DIA_CHI_START8						DATA_SPEED[28]=255 // -- OK
#define	ID8									 			DATA_SPEED[29]=8
#define Ban_2_next						    DATA_SPEED[30]=1
#define Ban_2_back				        DATA_SPEED[30]=0
#define	Ban_2											DATA_SPEED[31]

#define	DIA_CHI_START9						DATA_SPEED[32]=255 // -- OK
#define	ID9												DATA_SPEED[33]=9 
#define Ban_3_next				 				DATA_SPEED[34]=1
#define Ban_3_back								DATA_SPEED[34]=0 
#define	Ban_3											DATA_SPEED[35]


#define	DIA_CHI_START10						DATA_SPEED[36]=255 // -- OK
#define	ID10											DATA_SPEED[37]=10 
#define Nong_Ban_Up				 				DATA_SPEED[38]=0
#define Nong_Ban_Down							DATA_SPEED[38]=1
#define	Nong_Ban		 							DATA_SPEED[39]
//================================================================================	==========

#define	DIA_CHI_START11								DATA_SPEED[40]=255 // -- OK
#define	ID11													DATA_SPEED[41]=11 
#define XI_LANH_ON										DATA_SPEED[42]=1
#define XI_LANH_OFF										DATA_SPEED[42]=0
#define	XI_LANH												DATA_SPEED[43]

#define	DIA_CHI_START12						DATA_SPEED[44]=255 // -- OK
#define	ID12											DATA_SPEED[45]=12
#define Mor_Ha				 						DATA_SPEED[46]=0
#define Mor_Nang									DATA_SPEED[46]=1
#define	Mor_NangHa								DATA_SPEED[47]
...
#define bien_tro_nong_ban										_ADC1_Value[3]			//OK
#define bien_tro_nang_bong									_ADC1_Value[3]
#define bien_tro_nang_lua										_ADC1_Value[2]
#define bien_tro_xoay_nong									_ADC1_Value[0]
...
//#define  Home_Rear_Left											GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_0) // -- OK
#define  Home_Rear_Right										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2)
#define  Home_Front_Left										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_15)
...
#define Encoder_Front_Left	(vs32)((num_over_t5<<16) | TIM_GetCounter(TIM5))/7.3 //ok
#define Encoder_Front_Right	(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/7.2 //ok
#define Encoder_Rear_Right		(vs32)((num_over_t3<<16) | TIM_GetCounter(TIM3))/7.2 //ok
//#define Encoder_Rear_Left			(vs32)((num_over_t4<<16) | TIM_GetCounter(TIM4))/7.2
...
int 	lazeSauValue,lazeTruocValue,lazeTraiValue,lazePhaiValue,UWBValue;	
...
int target_BT_Xoay = 100;
int Min_BT_Xoay =  465;
int Max_BT_Xoay = 575;

int taget_BT_Nong_Ban; //258
int Min_BT_Nong_Ban = 210;
int Max_BT_Nong_Ban = 380;
//int goc_ban = 440;//
...
{		
	...
	DMA_InitStructure.DMA_BufferSize = 5;//(uint16_t)sizeof(Buffer);
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 1:
										...
										break;
									case 2:
										HMI_DMI("Nang_Ha_nong:",taget_BT_Nong_Ban	,2);
										break;
									case 3:
										HMI_DMI("Luc Ban: ", luc_now ,3);
										break;
									case 4:
										HMI_DMI("bientroxoay: ",BienTroNongBanValue,4);
										break;
									case 5:
										HMI_DMI("XI LANH ",bientronangbongValue,5);
										break;
									case 6:
...
//										}
										break;
									case 10:	  
										HMI_DMI("RX_USART4:",RX_USART4[0],10);
										break;
									case 11:
										HMI_DMI("UWB :",UWBValue,11);  					
										break;
									case 12:
										HMI_DMI("Game_Pad:",BAT,12);  						
										break;
									case 13:

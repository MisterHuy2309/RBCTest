...
#define Cylinder_ban_next					DATA_SPEED[54]=0
#define Cylinder_ban_back					DATA_SPEED[54]=1
#define	Cylinder_ban							DATA_SPEED[55]


#define	DIA_CHI_START15						DATA_SPEED[56]=255 // -- OK
#define	ID15											DATA_SPEED[57]=15 
#define Nongban_next							DATA_SPEED[58]=1
#define Nongban_back							DATA_SPEED[58]=0
...
//=============================ADC DMI======================================//
#define cam_bien_laze_trai			       			 _ADC1_Value[5]//7
#define cam_bien_laze_phai			       			 _ADC1_Value[6]
#define cam_bien_laze_sau								 		 _ADC1_Value[4]
#define cam_bien_laze_truoc							 		 _ADC1_Value[7]
    
#define bien_tro_nong_ban										_ADC1_Value[1]			//OK
#define bien_tro_nang_bong									_ADC1_Value[0]
#define bien_tro_nang_lua										_ADC1_Value[2] //2
...
#define   XI_LANH_RE_BONG_ON								GPIO_WriteBit(GPIOB,GPIO_Pin_0,1) // -- OK (B 10)
#define   XI_LANH_RE_BONG_OFF								GPIO_WriteBit(GPIOB,GPIO_Pin_0,0)

#define   XI_LANH_KEP_DONG									GPIO_WriteBit(GPIOB,GPIO_Pin_6,0) // -- OK
#define   XI_LANH_KEP_MO										GPIO_WriteBit(GPIOB,GPIO_Pin_6,1)

#define   XI_LANH_BAN_BONG_ON								GPIO_WriteBit(GPIOB,GPIO_Pin_13,1) // -- OK
#define   XI_LANH_BAN_BONG_OFF							GPIO_WriteBit(GPIOB,GPIO_Pin_13,0)
...
#define  Home_0h																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_0) // -- OK
#define  Home_4h																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_1)
#define  Home_8h																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2)
...
#define Encoder_0h			(vs32)((num_over_t3<<16) | TIM_GetCounter(TIM3))/7.18 
#define Encoder_4h			(vs32)((num_over_t5<<16) | TIM_GetCounter(TIM5))/7.18 //TRONG78.32306
#define Encoder_8h			(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/7.18
...
extern uint8_t bienTestLucChuyen;
///lazer
extern int kc_imu_1,kc_imu_2;
...
const int Min_BT_Nong_Ban = 78 + Troi_Bientro;
const int Max_BT_Nong_Ban = 1063 - Min_BT_Nong_Ban;
int state_nang = 1;
int state_ha = 1;

float testluc = 0;
float power_shot , power_pass;
...
{
    if(RX_USART6[0] == 0xAA && RX_USART6[1] == 0x55)
    {
        int32_t offset = (RX_USART6[5] << 24) | 
                        (RX_USART6[4] << 16) |
                        (RX_USART6[3] << 8) | 
                        RX_USART6[2];
    }
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 1:
										...
										break;
									case 2:
										HMI_DMI("LucTuDong:",	power_shot + testluc,2); // testluc , power_shot
										break;
									case 3:
										//HMI_DMI("BT_MAM_XOAY :",BienTroXoayValue,3);
										HMI_DMI("Bu_tru_luc ",testluc,3);
										break;
									case 4:
										//HMI_DMI("Luc Ban: ",degree,4);
										//HMI_DMI("testluc: ",testluc,4);Nongban
										HMI_DMI("Toc_do_nangha: ",Nongban,4);
										break;
									case 5:
										//HMI_DMI("Gia_tri_lazer ",lazeTruocValue,5);
										HMI_DMI("kc_laser: ",kc_laser,5);
										break;
									case 6:
										HMI_DMI("ENCODER_0H ",(int)ENCODER_0h(),6);
										break;
									case 7:
										//HMI_DMI("LUC ",khoan_cach_ban,7);
										HMI_DMI("lazeTraiValue_Ban",lazeTraiValue_Ban,7);
										break;
									case 8:
										HMI_DMI("K/C_Chuyen ",UWB,8);
								//		HMI_DMI("chuyen_bong_test ",bienTestLucChuyen,8);
										break;
									case 9:
										HMI_DMI("BT Nang_Ha :",bientronangluaValue,9);
										break;
//										if(NUT_CHUYEN_SAN == 1){
...
//										}
										break;
									case 10:	  
									HMI_DMI("lazeTraiValue :",lazeTraiValue,10);
										break;
									case 11:
										HMI_DMI("BT_Nang_Ha:",bientronangluaValue,11);  					
										break;
									case 12:
										//HMI_DMI("Luc Chuyen:",calculate(UWB - 15),12); // power_shot , testluc  
										HMI_DMI("Luc Chuyen: ",power_pass,12);
										break;
									case 13:
										HMI_DMI(" _4h_Wheel_Angle: ",vu_v,13);   
										break;
									case 14:
										HMI_DMI("_8h_Wheel_Angle : ",_8h_Wheel_Angle,14);  
										break;		
									case 15:
										//HMI_DMI("Force_track:",UWB,15); //Nongban
									HMI_DMI("_0h_Wheel_Angle: ",_0h_Wheel_Angle,15); 
										break;
								  case 16:

...
int Home_Encoder_RL = 1540, Home_Encoder_RR = 1720, Home_Encoder_FL = 1600, Home_Encoder_FR = 1880;
...
vu8 Home_wheel_RL_Out(void)
{
	...
	else										{	mor_rotate_rear_left = 50; return 0;}
...
vu8 Home_wheel_RL(void)
{
	...
	if(Home_Rear_Left == 1 && SS_RL == 0){
		mor_rotate_rear_left = 50; TIM3->CNT = 0; num_over_t3 = 0;return 0;
	}
	else if((abs(ENCODER_RL()) > Home_Encoder_RL) && SS_RL == 1){	
		mor_rotate_rear_left = 2 ;return 1;
	}
	else{
		mor_rotate_rear_left = 20; SS_RL = 1; return 0;
	}			
...
vu8 Home_wheel_RR(void)
{
	...
	if(Home_Rear_Right == 1 && SS_RR == 0)																{	mor_rotate_rear_right = 50; TIM4->CNT = 0; num_over_t4 = 0;return 0;}

...
#define Ban_3_next				 				DATA_SPEED[42]=1
#define Ban_3_back								DATA_SPEED[42]=0 
...
#define Nong_Ban_Up				 				DATA_SPEED[46]=0
#define Nong_Ban_Down							DATA_SPEED[46]=1
...
#define Mor_Ha				 						DATA_SPEED[54]=0
#define Mor_Nang									DATA_SPEED[54]=1
#define	Mor_NangHa								DATA_SPEED[55]
...
#define  CB_NHAN_BONG_BO_BAN										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_14)// -- OK
...
#define  Home_Front_Left										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2)
#define  Home_Front_Right										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_3)
//================================INPUT==================================//
...
#define Encoder_Front_Right	(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/61.2
#define Encoder_Rear_Left		(vs32)((num_over_t3<<16) | TIM_GetCounter(TIM3))/61.2
#define Encoder_Rear_Right	(vs32)((num_over_t4<<16) | TIM_GetCounter(TIM4))/61.2
...
//###########  SETTING NANG HA  ##############################################
const int Troi_Bientro_48 = 0;
int taget_BT_Nong_Ban = 200;
const int Min_BT_Nong_Ban = 51 ;
const int Max_BT_Nong_Ban = 666 - Min_BT_Nong_Ban  ;
float power = 60;
//int goc_ban = 440;//
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 1:
										...
										break;
									case 2:
										HMI_DMI("Nang_Ha_nong:",bien_tro_nong_ban	,2);
										break;
									case 3:
										HMI_DMI("Luc Ban: ", power_shot,3); //force , power , power_shot 
										break;
									case 4:
										HMI_DMI("bientroxoay: ",bien_tro_xoay_nong,4);
										break;
									case 5:
										HMI_DMI("GT_Laze ",lazeTraiValue,5);
										break;
									case 6:
										HMI_DMI("ENCODER_FR ",ENCODER_FL(),6);
										break;
									case 7:

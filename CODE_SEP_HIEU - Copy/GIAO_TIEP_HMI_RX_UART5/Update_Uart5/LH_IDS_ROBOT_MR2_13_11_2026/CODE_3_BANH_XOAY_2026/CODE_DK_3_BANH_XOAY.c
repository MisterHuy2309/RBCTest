...
servo_value_trai = (int)((long)(goc_rc_banh_trai) * 4095L / 3600L+20);
servo_value_phai = (int)((long)goc_rc_banh_phai * 4095L / 3600L)+10;
servo_value_sau  = (int)((long)goc_rc_banh_sau  * 4095L / 3600L)-20;

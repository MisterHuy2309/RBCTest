...
//--------------------------------------------------------------
#define FLASH_SEKTOR_SIZE    ((uint32_t)0x20000)     // 16kByte
#define FLASH_SEKTOR2_START  ((uint32_t)0x08020000) // Sektor_5
#define FLASH_SEKTOR3_START  ((uint32_t)0x08040000) // Sektor_6

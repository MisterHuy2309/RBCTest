...
vs32 Dc_Nang_Ha = 0;
vs32 goc_banh_trai,goc_banh_phai,goc_banh_sau  ,servo_value_trai , servo_value_sau,servo_value_phai,nang_chan_trai, nang_chan_sau, nang_chan_phai,goc_rc_banh_trai,goc_rc_banh_phai,goc_rc_banh_sau ;
...
vs32 t7,BEN_NGAT;
extern vu16 laser_truoc;
extern int test_bit;
extern float Tang_GiamCB;
extern int Press_Tam_Giac , Press_X;
int testxung = 0;
...
//#define  CB_BANH_TRUOC_1					GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_8)                          
#define  CB_BANH_TRUOC_2					GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_15)
#define  CB_BANH_TRUOC_1          GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_0)

#define  CB_BANH_SAU_1				  	GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_1)                          
#define  CB_BANH_SAU_2				  	GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_13)


///Khai Bao xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
#define  CB_Nang_Chan_Truoc					GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_15)
#define  CB_Ha_Chan_Truoc          	GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_0)
#define  CB_Nang_Chan_Sau				  	GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_3)                          
#define  CB_Ha_Chan_Sau				  		GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_13)

#define  CB_TAY_KEP_VU_KHI				  GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_1)
#define  CB_SAU_ROBOT							  GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_14)
#define  CB_XI_LANH_DAY_KFS				  GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_8)
#define  CB_TAY_KEP_KFS						  GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_0)
#define  CB_HANH_TRINH_TAY_KEP_RA			GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_13)
#define  CB_HANH_TRINH_TAY_KEP_VAO		GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_13)




//#define laser_truoc                _ADC1_Filtered[10]              
...
#define	 Laser_on           		  GPIO_WriteBit(GPIOB, GPIO_Pin_14,1);
#define	 Laser_off           			GPIO_WriteBit(GPIOB, GPIO_Pin_14,0);

#define	 xilanh_ban_nha          	GPIO_WriteBit(GPIOB, GPIO_Pin_15,1); // Bo Ban
#define	 xilanh_ban_kep          	GPIO_WriteBit(GPIOB, GPIO_Pin_15,0);

#define	 xilanh_thu_kep          	GPIO_WriteBit(GPIOA, GPIO_Pin_8,0); // chan 15
#define	 xilanh_thu_nha         	GPIO_WriteBit(GPIOA, GPIO_Pin_8,1);

/////////////////

#define	 XI_LANH_KEP_ON          		GPIO_WriteBit(GPIOB, GPIO_Pin_12,0); // chan 15
#define	 XI_LANH_KEP_OFF         		GPIO_WriteBit(GPIOB, GPIO_Pin_12,1);

#define	 XI_LANH_GIU_KFS_TRUOC_ON         GPIO_WriteBit(GPIOB, GPIO_Pin_13,0); // chan 15
#define	 XI_LANH_GIU_KFS_TRUOC_OFF        GPIO_WriteBit(GPIOB, GPIO_Pin_13,1);

#define	 XI_LANH_GIU_KFS_SAU_ON         GPIO_WriteBit(GPIOD, GPIO_Pin_10,1); // chan 15
#define	 XI_LANH_GIU_KFS_SAU_OFF        GPIO_WriteBit(GPIOD, GPIO_Pin_10,0);

#define	 XI_LANH_DAY_KFS_RA         GPIO_WriteBit(GPIOA, GPIO_Pin_8,1); // chan 15
#define	 XI_LANH_DAY_KFS_VAO        GPIO_WriteBit(GPIOA, GPIO_Pin_8,0);

#define	 XI_LANH_KEP_VU_KHI_ON      GPIO_WriteBit(GPIOB, GPIO_Pin_14,1); // chan 15
#define	 XI_LANH_KEP_VU_KHI_OFF     GPIO_WriteBit(GPIOB, GPIO_Pin_14,0);

#define	 XI_LANH_VU_KHI_UP          GPIO_WriteBit(GPIOB, GPIO_Pin_15,0); // chan 15
#define	 XI_LANH_VU_KHI_DOWN        GPIO_WriteBit(GPIOB, GPIO_Pin_15,1);

#define	 XI_LANH_TAY_KEP_LEN         GPIO_WriteBit(GPIOD, GPIO_Pin_14,1); // chan 15
#define	 XI_LANH_TAY_KEP_XUONG       GPIO_WriteBit(GPIOD, GPIO_Pin_14,0);
...
#define  DC_xoay_trai 	  		DATA_SPEED[32]=1
#define  DC_xoay_phai 	    	DATA_SPEED[32]=0
#define	 DC_xoay			   				DATA_SPEED[33]
...
#define	ID11 		 												DATA_SPEED[51]=11
#define	DC_NANG_HA_TAY_KEP(N)				  	((DATA_SPEED[53]=N&0xFF)| (DATA_SPEED[52]=(N>>8)&0xFF))

#define	DIA_CHI_START12   							DATA_SPEED[54]=255    // Ðong co nâng -- cau H
#define	ID12 		 			  	    					DATA_SPEED[55]=12
#define DC_TAY_KEP_RA 	  							DATA_SPEED[56]=0
#define DC_TAY_KEP_VAO 	    						DATA_SPEED[56]=1
#define	DC_TAY_KEP			   							DATA_SPEED[57]
...
//////////  BIT_ESP32_CONTROLLER ///////

#define PICK_LANE 							RX_USART6[2]

#define CELL_1 									RX_USART6[3]
#define CELL_2 									RX_USART6[4]
#define CELL_3 									RX_USART6[5]
#define CELL_4 									RX_USART6[6]

#define CHECK_CELL_1 						RX_USART6[7]
#define CHECK_CELL_2 						RX_USART6[8]
#define CHECK_CELL_3 						RX_USART6[9]
#define CHECK_CELL_4 						RX_USART6[10]
...
//---------------------------- KHAI BAO UART 4-----------------------------
//#define HEADER_BYTE_UART4  0xAA
//#define UART4_BUFFER_SIZE 15
//vu8 RX_USART4[UART4_BUFFER_SIZE];
//vu8	CAMERA;
////vu8 received_offset = 0;  
////int received_uwb = 0;	
////vu8 send_data = 0;
// Các d?nh nghia bi?n toàn c?c c?n có
#define UART4_BUFFER_SIZE 1
vu8 RX_USART4[UART4_BUFFER_SIZE];
...
{       
    ...
    // 1. C?p Clock (Luu ý: UART4 n?m trên APB1, Chân C n?m trên AHB1, DMA1 n?m trên AHB1)
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART4, ENABLE);
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC, ENABLE); // S?a t? GPIOA thành GPIOC
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_DMA1, ENABLE);

    /*-------------------------- GPIO Configuration ----------------------------*/
    // C?u hình PC10 (TX) và PC11 (RX)
    ...
    // 3. C?u hình NVIC cho DMA (S? d?ng DMA1 Stream2 cho UART4_RX)
    NVIC_PriorityGroupConfig(NVIC_PriorityGroup_2);
    
    NVIC_InitStructure.NVIC_IRQChannel = DMA1_Stream2_IRQn; // Stream 2 ng?t cho UART4 Rx
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 3; // Priority gi?ng UART6
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = 0;
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
    ...
    // Tra b?ng DMA Request Mapping: UART4_RX là DMA1, Stream 2, Channel 4
    DMA_InitStructure.DMA_Channel = DMA_Channel_4; 
    DMA_InitStructure.DMA_DIR = DMA_DIR_PeripheralToMemory; // Nh?n t? ngo?i vi v? RAM
    DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)RX_USART4; // Ð?a ch? m?ng nh?n
    DMA_InitStructure.DMA_BufferSize = 10; //UART4_BUFFER_SIZE;
    DMA_InitStructure.DMA_PeripheralBaseAddr = (uint32_t)&UART4->DR; // Ð?a ch? thanh ghi d? li?u UART4
    DMA_InitStructure.DMA_PeripheralInc = DMA_PeripheralInc_Disable;
    DMA_InitStructure.DMA_MemoryInc = DMA_MemoryInc_Enable;
    DMA_InitStructure.DMA_PeripheralDataSize = DMA_PeripheralDataSize_Byte;
    DMA_InitStructure.DMA_MemoryDataSize = DMA_MemoryDataSize_Byte;
    DMA_InitStructure.DMA_Mode = DMA_Mode_Circular; // Ch? d? vòng tròn
    DMA_InitStructure.DMA_Priority = DMA_Priority_High;
    DMA_InitStructure.DMA_FIFOMode = DMA_FIFOMode_Enable;
    DMA_InitStructure.DMA_FIFOThreshold = DMA_FIFOThreshold_Full;
    DMA_InitStructure.DMA_MemoryBurst = DMA_MemoryBurst_Single;
    ...
    USART_DMACmd(UART4, USART_DMAReq_Rx, ENABLE); // Cho phép UART4 yêu c?u DMA
...
#define RX_UART5_SIZE 64

volatile uint16_t RxUart[RX_UART5_SIZE];
volatile uint16_t RxUart_Index = 0;
...
void UART5_IRQHandler(void)
{
    ...
    static uint16_t temp12  = 0;

    if (USART_GetITStatus(UART5, USART_IT_RXNE) != RESET)
    {
        uint8_t byte = (uint8_t)USART_ReceiveData(UART5);

        if (rx_state == 0)
        {
            temp12 = (byte & 0x0F) << 8;   // 4 bit cao
            rx_state = 1;
        }
        else
        {
            temp12 |= byte;              // 8 bit th?p
            RxUart[RxUart_Index++] = temp12;

            if (RxUart_Index >= RX_UART5_SIZE)
                RxUart_Index = 0;
...
#define DATA_LEN          12       // S? lu?ng ô vuông
#define UART5_BUFFER_SIZE 15       // 1 Header + 1 Len + 12 Data + 1 Checksum

vu8 RX_UART5[UART5_BUFFER_SIZE];   
vu8 Data_O_Vuong[DATA_LEN];        
vu8 send_data_u5 = 0;              

void UART5_DMA_RX(u32 baudrate)
{       
    DMA_InitTypeDef DMA_InitStructure;
    NVIC_InitTypeDef NVIC_InitStructure;
    USART_InitTypeDef USART_InitStructure;
    ...
    DMA_InitStructure.DMA_Channel = DMA_Channel_4;
    DMA_InitStructure.DMA_DIR = DMA_DIR_PeripheralToMemory;
    DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)RX_UART5;
    ...
    // --- S?A QUAN TR?NG: Dùng Normal Mode d? d? ki?m soát Header ---
    ...
    DMA_ITConfig(DMA1_Stream0, DMA_IT_TC, ENABLE); // Ng?t khi d?y b? d?m
    DMA_Cmd(DMA1_Stream0, ENABLE);
}

// Hàm x? lý d? li?u (Logic gi? nguyên)
void UART5_ProcessData(void) 
{
    int i;
    vu8 len = RX_UART5[1]; 
    
    // Ki?m tra Len h?p l? d? tránh truy c?p m?ng sai v? trí
    if (len != DATA_LEN) {
        send_data_u5 = 0;
        return; 
    }

    uint8_t received_checksum = RX_UART5[2 + len];
    uint8_t calc_sum = HEADER_BYTE + len;

    for(i = 0; i < len; i++) {
        calc_sum += RX_UART5[2 + i];
    }
    calc_sum &= 0xFF;

    if(RX_UART5[0] == HEADER_BYTE && received_checksum == calc_sum) 
    {
        send_data_u5 = 1; 
        for(int k = 0; k < DATA_LEN; k++) {
            Data_O_Vuong[k] = RX_UART5[2 + k];
        }
    } 
    else 
    {
...
//						break;
				...
				case 10:
						HMI_DMI("RX_USART6[1] : ", RX_USART6[1]  , 10);	 																
						break;
									
				case 11:
						HMI_DMI("RX_USART6[0]: ", RX_USART6[0], 11);						
						break;
									
				case 12:
						HMI_DMI("testxung: ", testxung , 12);						
						break;
				...
				case 14:
						HMI_DMI("test_bit: ",test_bit , 14);					
						break;
									
				case 15:
						HMI_DMI("DC_TAY_KEP: ", DC_TAY_KEP, 15);										
						break;
                ...
                GPIO_ReadOutputDataBit(GPIOB, GPIO_Pin_7)
						...
						case 18:
						HMI_DMI("READ_ENCODER_2: ", READ_ENCODER_2(), 18);										
						break;
						...
						break;
				case 20:
						HMI_DMI("banh_phai: ", _TOC_DO_BP, 20);										
						break;
				...
				case 22:
						HMI_DMI("laser_truoc: ", laser_truoc, 22);					
						break;
				...
				case 27:
				   	HMI_DMI("TOUCHPAD: ", TOUCHPAD, 27);	
						break;
									
				case 28:
			//		  HMI_DMI("_ADC1_Filtered[12]: ", _ADC1_Filtered[14], 28);	
						break;
				case 29:
						HMI_DMI("IMU_X: ", IMU_X, 29);	
						break;
				...
				case 31:
						HMI_DMI("_ADC1_Filtered[10]: ",_ADC1_Filtered[10] , 31);					
						break;
				...
				case 35:
				  snprintf(_ghep_bit, sizeof(_ghep_bit), " %d %d %d %d%",
								RX_UART5[0],
								RX_UART5[1],
								RX_UART5[2],
								RX_UART5[3]
            ); 
						HMI_PUTS("Bit_HMI: ", _ghep_bit, 35);	
						break;
...
////								RX_USART6[1],
						...
						break;
				case 37:
						HMI_DMI("ECD2: ", READ_ENCODER_2(), 37);	
						break;
									
				case 38: 
						HMI_DMI("Press_Tam_Giac: ", Press_Tam_Giac, 38);					
						break;
									
				case 39:
						HMI_DMI("Press_X: ",Press_X , 39);					
						break;
